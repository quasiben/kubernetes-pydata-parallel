...
class V1PodSpec(object):
    ...
    """
    def __init__(self, dns_policy=None, restart_policy=None, active_deadline_seconds=None, host_ipc=None, image_pull_secrets=None, containers=None, service_account=None, volumes=None, node_selector=None, service_account_name=None, security_context=None, node_name=None, host_pid=None, hostname=None, termination_grace_period_seconds=None, host_network=None, subdomain=None):
        """
