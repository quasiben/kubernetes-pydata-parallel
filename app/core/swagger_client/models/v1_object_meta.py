...
class V1ObjectMeta(object):
    ...
    """
    def __init__(self, namespace=None, finalizers=None, self_link=None, annotations=None, name=None, owner_references=None, deletion_grace_period_seconds=None, generation=None, generate_name=None, cluster_name=None, labels=None, uid=None, resource_version=None, deletion_timestamp=None, creation_timestamp=None):
        """
