...
class V1beta1DeploymentSpec(object):
    ...
    """
    def __init__(self, selector=None, template=None, revision_history_limit=None, progress_deadline_seconds=None, min_ready_seconds=None, paused=None, strategy=None, rollback_to=None, replicas=None):
        """
