...
class V1Event(object):
    ...
    """
    def __init__(self, metadata=None, kind=None, last_timestamp=None, message=None, count=None, api_version=None, first_timestamp=None, type=None, source=None, reason=None, involved_object=None):
        """
