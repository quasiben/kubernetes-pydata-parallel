...
class V1Probe(object):
    ...
    """
    def __init__(self, failure_threshold=None, tcp_socket=None, timeout_seconds=None, initial_delay_seconds=None, success_threshold=None, http_get=None, period_seconds=None, _exec=None):
        """
