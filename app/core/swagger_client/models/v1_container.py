...
class V1Container(object):
    ...
    """
    def __init__(self, command=None, image_pull_policy=None, tty=None, liveness_probe=None, ports=None, volume_mounts=None, args=None, name=None, termination_message_path=None, stdin=None, image=None, stdin_once=None, resources=None, lifecycle=None, readiness_probe=None, working_dir=None, env=None, security_context=None):
        """
