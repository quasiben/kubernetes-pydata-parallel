...
class V1ServiceSpec(object):
    ...
    """
    def __init__(self, selector=None, ports=None, deprecated_public_i_ps=None, cluster_ip=None, session_affinity=None, type=None, external_i_ps=None, external_name=None, load_balancer_ip=None, load_balancer_source_ranges=None):
        """
