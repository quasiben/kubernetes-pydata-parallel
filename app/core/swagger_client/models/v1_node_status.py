...
class V1NodeStatus(object):
    ...
    """
    def __init__(self, images=None, phase=None, addresses=None, daemon_endpoints=None, conditions=None, volumes_in_use=None, volumes_attached=None, capacity=None, allocatable=None, node_info=None):
        """
